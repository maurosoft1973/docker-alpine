...
* ```:3.13.2``` 3.13.2 branch based (Automatic Architecture Selection)
* ```:3.13.2-aarch64```   3.13.2 64 bit ARM
* ```:3.13.2-armhf```     3.13.2 32 bit ARM v6
* ```:3.13.2-armv7```     3.13.2 32 bit ARM v7
* ```:3.13.2-ppc64le```   3.13.2 64 bit PowerPC
* ```:3.13.2-x86```       3.13.2 32 bit Intel/AMD
* ```:3.13.2-x86_64```    3.13.2 64 bit Intel/AMD
...
***
###### Last Update 12.03.2022 19:06:26
