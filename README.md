...
* ```:3.13.3``` 3.13.3 branch based (Automatic Architecture Selection)
* ```:3.13.3-aarch64```   3.13.3 64 bit ARM
* ```:3.13.3-armhf```     3.13.3 32 bit ARM v6
* ```:3.13.3-armv7```     3.13.3 32 bit ARM v7
* ```:3.13.3-ppc64le```   3.13.3 64 bit PowerPC
* ```:3.13.3-x86```       3.13.3 32 bit Intel/AMD
* ```:3.13.3-x86_64```    3.13.3 64 bit Intel/AMD
...
***
###### Last Update 12.03.2022 19:23:00
